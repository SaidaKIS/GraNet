...
class UNet(nn.Module):
    """
    Channels can correspond to diferent observables or temporal sequence - depends of the input
    """
    def __init__(self, n_channels, n_classes, scale=1, bilinear=True, dropout=True):
